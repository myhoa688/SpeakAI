        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
          <div style={{ width: '100%', maxWidth: '440px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '1.25rem' }}>
              <h2 style={{ fontSize: '1.65rem', fontWeight: 700, marginBottom: '0.25rem', color: 'var(--ink)' }}>Đăng ký</h2>
              <p style={{ color: 'var(--muted)', fontSize: '0.9rem' }}>Nhập thông tin đăng ký để tạo tài khoản của bạn</p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ background: 'var(--surface)', padding: '1.75rem 2rem', borderRadius: '16px', border: '1px solid var(--border)', boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
              ...
              <div style={{ marginBottom: '0.875rem' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.5rem', color: 'var(--ink)' }}>Họ và tên</label>
              ...
              <div style={{ marginBottom: '0.875rem' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.4rem', color: 'var(--ink)' }}>Email</label>
                <div style={{ position: 'relative' }}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ position: 'absolute', left: '14px', top: '13px', width: '18px', height: '18px', color: 'var(--muted)' }}>
              ...
              <button 
                ...
                disabled={loading}
              >
                <LogIn size={18} /> {loading ? 'Đang xử lý...' : 'Đăng ký ngay'}
              </button>

              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1rem 0' }}>
                <div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div>
                <span style={{ fontSize: '0.8rem', color: 'var(--muted)', fontWeight: 500 }}>Hoặc đăng ký với</span>
                <div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div>
              </div>
            ...
            <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.9rem', color: 'var(--muted)' }}>
              Đã có tài khoản? <Link to="/login" style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: 600 }}>Đăng nhập ngay</Link>
            </p>
          </div>
        </div>
      </div>
